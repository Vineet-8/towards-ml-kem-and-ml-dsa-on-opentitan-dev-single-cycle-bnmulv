...
#(
  ...
  parameter int ImemSizeByte = 8192,
  // Size of the data memory, in bytes
  parameter int DmemSizeByte = 131072,
  ...
  mulv_predec_bignum_t      mulv_predec_bignum;
  // ToDo
  mulv_predec_bignum_t      unused_mulv_predec_bignum;
  assign unused_mulv_predec_bignum = mulv_predec_bignum;
  ...
  mulv_bignum_operation_t mulv_bignum_operation;
  logic [WLEN-1:0]        mulv_bignum_operation_result;
  logic                   mulv_bignum_en;
  logic [63:0]            mulv_mod;
  ...
  otbn_instruction_fetch #(
    ...
    .mulv_predec_bignum_o     (mulv_predec_bignum),
  ...
  otbn_controller #(
    ...
    // To/from bignum MULV
    .mulv_bignum_operation_o       (mulv_bignum_operation),
    .mulv_bignum_operation_result_i(mulv_bignum_operation_result),
    .mulv_bignum_en_o              (mulv_bignum_en),
    .mulv_mod_i                    (mulv_mod),

    //.mulv_bignum_commit_o          (mulv_bignum_commit),
  ...
  otbn_mulv u_otbn_mulv (
    .operation_i(mulv_bignum_operation),
    .mulv_en_i(mulv_bignum_en),
    .multiplier_result_o(mulv_bignum_operation_result)
  );
