...
#(
  ...
  // Bignum MULV
  output mulv_bignum_operation_t mulv_bignum_operation_o,
  input  logic [WLEN-1:0]        mulv_bignum_operation_result_i,
  output logic                   mulv_bignum_en_o,
  input logic [63:0]             mulv_mod_i,
  //output logic                  mac_bignum_commit_o,
  ...
  assign alu_bignum_operation_o.vector_type = insn_dec_bignum_i.alu_vector_type;
  assign alu_bignum_operation_o.vector_sel  = insn_dec_bignum_i.alu_vector_sel;
  ...
  assign mulv_bignum_operation_o.operand_a = rf_bignum_rd_data_a_no_intg;
  assign mulv_bignum_operation_o.operand_b = rf_bignum_rd_data_b_no_intg;
  assign mulv_bignum_operation_o.mod = mulv_mod_i;
  assign mulv_bignum_operation_o.vector_type = insn_dec_bignum_i.mulv_type;
  assign mulv_bignum_operation_o.lane_idx = insn_dec_bignum_i.mulv_lane_idx;

  assign mulv_bignum_en_o = insn_valid_i & insn_dec_bignum_i.mulv_en;
  ...
  always_comb begin
    ...
    unique case (insn_dec_bignum_i.rf_wdata_sel)
      ...
      RfWdSelMulv: begin
        rf_bignum_wr_data_no_intg_o  = mulv_bignum_operation_result_i;
      end
      RfWdSelIspr: begin
